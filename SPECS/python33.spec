...
# move libpython to 3.3, this will avoid conflicts in the future
mv %{buildroot}/%{_libdir}/libpython3.so %{buildroot}/%{_libdir}/libpython%{pybasever}.so
...
%changelog
* Tue Sep 19 2017 Ben Harper <ben.harper@rackspace.com> - 3.3.7-1.ius
- Latest upstream
- remove Patch167, patched upstream
- update Patch55
...
* Wed Jun 18 2014 Carl George <carl.george@rackspace.com> - 3.3.5-2.ius
...
* Thu Oct 11 2012 Ben Harper <ben.harper@rackspace.com> - 3.3.0-6-ius
- removing sym links so python33 can be installed along side python32

* Wed Oct 10 2012 Ben Harper <ben.harper@rackspace.com> - 3.3.0-5-ius
- added patch 166 to skip some locale tests
- added tagging on the python version to bin files

* Tue Oct 9 2012 Ben Harper <ben.harper@rackspace.com> - 3.3.0-4-ius
- fixes for for el6 < 6.3

* Mon Oct 8 2012 Ben Harper <ben.harper@rackspace.com> - 3.3.0-3.ius
- added patch 165 to skip gdb test

* Wed Oct 3 2012 Ben Harper <ben.harper@rackspace.com> - 3.3.0-2.ius
- Porting from Fedora to IUS python33
